...
use super::common::{calculate_rms, calculate_peak, assert_samples_in_range, assert_samples_are_finite};
...
fn test_synth_velocity_affects_amplitude() {
    ...
    assert!(high_vel_rms > low_vel_rms, "Higher velocity should be louder");
}
